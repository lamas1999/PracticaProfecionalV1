  ...
  <div class="modal-dialog" role="document">
    ...
    <!--   <h4 class="modal-title" id="exampleModalLabel">Registro</h4> -->
      ...
      <div class="modal-body">
        <p>Si usted está en busca de empleo o desea publicar 
        su currículo, por favor seleccione "Candidatos". 
    ...
    <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
                <h3>Universidad Tecnológica Privada de Santa Cruz de la Sierra</h3>
